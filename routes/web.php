...
use App\Http\Controllers\QcpController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::middleware(['role:prd|admin'])->group(function () {
        ...
        Route::get('/dashboard/prd', [PrdController::class, 'index'])->name('dashboard.prd.index');
    ...
    Route::middleware(['role:hr|admin'])->group(function () {
        ...
        Route::get('/dashboard/hr', [HrController::class, 'index'])->name('dashboard.hr.index');
    ...
    Route::middleware(['role:ga|admin'])->group(function () {
        ...
        Route::get('/dashboard/ga', [GaController::class, 'index'])->name('dashboard.ga.index');
    ...
    Route::middleware(['role:mkt|admin'])->group(function () {
        ...
        Route::get('/dashboard/mkt', [MktController::class, 'index'])->name('dashboard.mkt.index');
    ...
    Route::middleware(['role:bdrnd|admin'])->group(function () {
        ...
        Route::get('/dashboard/bdrnd', [BdRndController::class, 'index'])->name('dashboard.bdrnd.index');
    ...
    Route::middleware(['role:cnc|admin'])->group(function () {
        ...
        Route::get('/dashboard/cnc', [CncController::class, 'index'])->name('dashboard.cnc.index');
    ...
    Route::middleware(['role:wrhs|admin'])->group(function () {
        ...
        Route::get('/dashboard/wrhs', [WrhsController::class, 'index'])->name('dashboard.wrhs.index');
    ...
    Route::middleware(['role:qcs|admin'])->group(function () {
        ...
        Route::get('/dashboard/qcs', [QcsController::class, 'index'])->name('dashboard.qcs.index');
    ...
    Route::middleware(['role:qa|admin'])->group(function () {
        ...
        Route::get('/dashboard/qa', [QaController::class, 'index'])->name('dashboard.qa.index');
    ...
    Route::middleware(['role:mt|admin'])->group(function () {
        ...
        Route::get('/dashboard/mt', [MtController::class, 'index'])->name('dashboard.mt.index');
        Route::get('/mt/{id}/edit', [MtController::class, 'edit'])->name('dashboard.mt.edit');
        Route::PUT('/dashboard/mt/{id}', [MtController::class, 'update'])->name('dashboard.mt.update');
    });
    Route::middleware(['role:protech|admin'])->group(function () {
        Route::resource('protech', ProtechController::class);
        Route::get('/dashboard/protech', [ProtechController::class, 'index'])->name('dashboard.protech.index');
    ...
    Route::middleware(['role:farm|admin'])->group(function () {
        ...
        Route::get('/dashboard/farm', [FarmController::class, 'index'])->name('dashboard.farm.index');
        Route::get('/farm/{id}/edit', [FarmController::class, 'edit'])->name('dashboard.farm.edit');
        Route::PUT('/dashboard/farm/{id}', [FarmController::class, 'update'])->name('dashboard.farm.update');
    });
    Route::middleware(['role:export|admin'])->group(function () {
        Route::resource('export', ExportController::class);
        Route::get('/dashboard/export', [ExportController::class, 'index'])->name('dashboard.export.index');
        Route::get('/export/{id}/edit', [ExportController::class, 'edit'])->name('dashboard.export.edit');
        Route::PUT('/dashboard/export/{id}', [ExportController::class, 'update'])->name('dashboard.export.update');
    });
    ...
    Route::middleware(['role:purchase|admin'])->group(function () {
        ...
        Route::get('/dashboard/purchase', [PurchaseController::class, 'index'])->name('dashboard.purchase.index');
    ...
    Route::middleware(['role:qcp|admin'])->group(function () {
        Route::resource('qcp', QcpController::class);
        Route::get('/dashboard/qcp', [QcpController::class, 'index'])->name('dashboard.qcp.index');
        Route::get('/qcp/{id}/edit', [QcpController::class, 'edit'])->name('dashboard.qcp.edit');
        Route::PUT('/dashboard/qcp/{id}', [QcpController::class, 'update'])->name('dashboard.qcp.update');
    });
});
