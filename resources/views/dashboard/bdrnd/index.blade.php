      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <table id="example" class="cell-border compact stripe " style="width:100%">
            ...
            <tbody>
              @foreach ($bdrnds as $bdrnd)
                <tr>
                  <td class="break-words">{{ $bdrnd->proker }}</td>
                  <td class="break-words">{{ $bdrnd->renker }}</td>
                  <td class="break-words">{{ $bdrnd->target }}</td>
                  <td>{{ $bdrnd->janw1 == 'OK' ? '✔️' : $bdrnd->janw1 }}</td>
                  <td>{{ $bdrnd->janw2 == 'OK' ? '✔️' : $bdrnd->janw2 }}</td>
                  <td>{{ $bdrnd->janw3 == 'OK' ? '✔️' : $bdrnd->janw3 }}</td>
                  <td>{{ $bdrnd->janw4 == 'OK' ? '✔️' : $bdrnd->janw4 }}</td>
                  ...
                  <td style="text-align: center;">{{ $bdrnd->achieve }}</td>
