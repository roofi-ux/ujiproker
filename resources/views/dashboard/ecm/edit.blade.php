      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <div class="container mx-auto py-6">
            ...
            <div class="mb-4">
              <a ecmef="{{ route('dashboard.ecm.index') }}"
                          ...
                          @if (auth()->check() && auth()->user()->hasRole('user'))
                            ...
                            @if ($ecm->hasil)
                              <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">File PDF Tersimpan:
                                <a ecmef="{{ Storage::url($ecm->hasil) }}" target="_blank"
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-0" type="radio" value="0%" name="persen"
                                    ...
                                    {{ old('persen', $ecm->persen) == '0%' ? 'checked' : '' }} required>
                                  <label for="persen-0"
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-25" type="radio" value="25%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $ecm->persen) == '25%' ? 'checked' : '' }} required>
                                  <label for="persen-25"
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-50" type="radio" value="50%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $ecm->persen) == '50%' ? 'checked' : '' }} required>
                                  <label for="persen-50"
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-75" type="radio" value="75%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $ecm->persen) == '75%' ? 'checked' : '' }} required>
                                  <label for="persen-75"
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-100" type="radio" value="100%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $ecm->persen) == '100%' ? 'checked' : '' }} required>
