        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <table id="example" class="cell-border compact stripe " style="width:100%">
            ...
            <tbody>
              @foreach ($prds as $prd)
                <tr>
                  <td class="break-words">{{ $prd->proker }}</td>
                  <td class="break-words">{{ $prd->renker }}</td>
                  <td class="break-words">{{ $prd->target }}</td>
                  ...
                  <td class="break-words" style="text-align: center;">{{ $prd->ket }}</td>
