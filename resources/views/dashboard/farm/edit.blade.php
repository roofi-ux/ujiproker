      ...
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          ...
          <div class="container mx-auto py-6">
            <h1 class="text-2xl font-bold mb-4">Data Hasil farm</h1>
            ...
            @else
              ...
              <?php $farm = (object) ['id' => '', 'proker' => '', 'renker' => '', 'target' => '', 'Janw1' => '', 'Janw2' => '', 'Janw3' => '', 'Janw4' => '', 'hasil' => '', 'aproval' => '', 'ket' => '', 'persen' => '']; ?>
            @endif
            ...
            <div class="py-12">
              <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                  <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('dashboard.farm.update', $farm->id) }}"
                      ...
                      <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="proker" id="proker"
                            ...
                            placeholder=" " value="{{ old('proker', $farm->proker) }}" readonly />
                          <label for="proker"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="renker" id="renker"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('renker', $farm->renker) }}" readonly />
                          <label for="renker"
                      ...
                      <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="target" id="target"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('target', $farm->target) }}" readonly />
                          <label for="target"
                      ...
                      <div class="grid md:grid-cols-4 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="janw1" id="janw1"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('janw1', $farm->janw1) }}" readonly />
                          <label for="janw1"
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="janw2" id="janw2"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('janw2', $farm->janw2) }}" readonly />
                          <label for="janw2"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:end-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Januari
                            W2</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="janw3" id="janw3"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('janw3', $farm->janw3) }}" readonly />
                          <label for="janw3"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:end-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Januari
                            W3</label>
                        </div>
                        <div class="relative z-0 w-full mb-6 group">
                          <input type="text" name="janw4" id="janw4"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " value="{{ old('janw4', $farm->janw4) }}" readonly />
                          <label for="janw4"
                            class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:end-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Januari
                            W4</label>
                        </div>
                      ...
                      <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                          ...
                          @if (auth()->check() && auth()->user()->hasRole('farm'))
                            ...
                            @if ($farm->hasil)
                              <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">File PDF Tersimpan:
                                <a href="{{ Storage::url($farm->hasil) }}" target="_blank"
                                  class="underline text-blue-600 dark:text-blue-500 hover:text-blue-800 dark:hover:text-blue-700">{{ Str::afterLast($farm->hasil, '/') }}</a>
                              </p>
                            @endif
                          @else
                            @if ($farm->hasil)
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-50-59" type="radio" value="50%-59%" name="persen"
                                    ...
                                    {{ old('persen', $farm->persen) == '50%-59%' ? 'checked' : '' }} required>
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-60-69" type="radio" value="60%-69%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $farm->persen) == '60%-69%' ? 'checked' : '' }} required>
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-70-79" type="radio" value="70%-79%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $farm->persen) == '70%-79%' ? 'checked' : '' }} required>
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-80-89" type="radio" value="80%-89%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $farm->persen) == '80%-89%' ? 'checked' : '' }} required>
                              ...
                              <li>
                                <div class="flex items-center ps-3">
                                  <input id="persen-90-100" type="radio" value="90%-100%" name="persen"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                                    {{ old('persen', $farm->persen) == '90%-100%' ? 'checked' : '' }} required>
                          ...
                          @else
                            <input type="text"
                              class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                              value="{{ old('persen', $farm->persen) }}" readonly />
                          @endif
                          @error('persen')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                          @enderror
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                          ...
                          @if (auth()->check() && auth()->user()->hasRole('admin'))
                            <select name="achieve" id="achieve"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              required>
                              <option value="" {{ old('achieve', $farm->achieve) == '' ? 'selected' : '' }}>--
                                Pilih Achieve --</option>
                              <option value="Achieve"
                                {{ old('achieve', $farm->achieve) == 'Achieve' ? 'selected' : '' }}>Achieve</option>
                              <option value="Not Achieve"
                                {{ old('achieve', $farm->achieve) == 'Not Achieve' ? 'selected' : '' }}>Not Achieve
                              </option>
                            </select>
                          @else
                            <input type="text"
                              class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                              value="{{ old('achieve', $farm->achieve) }}" readonly />
                          @endif
                          @error('achieve')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                          @enderror
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                          ...
                          @if (auth()->check() && auth()->user()->hasRole('admin'))
                            <textarea name="ket" id="ket" rows="3"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              placeholder="Keterangan Tambahan (Opsional)">{{ old('ket', $farm->ket) }}</textarea>
                          @else
                            <textarea id="ket" rows="3"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                              readonly>{{ old('ket', $farm->ket) }}</textarea>
                          @endif
                          @error('ket')
                            <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                          @enderror
